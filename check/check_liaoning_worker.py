...
class CheckLiaoNingWorker(CheckBaseWorker):
    ...
    def get_shareholder_info(self, shareholder_info):
        ...
        :return: 返回工商schema字典
        '''
        check_flag = self.check_field(field_info=shareholder_info, classify='list', data_type='json')
        return check_flag
    ...
    def get_change_info(self, change_info):
        ...
        :return: 返回工商schema字典
        '''
        check_flag = self.check_field(field_info=change_info, feature_list=u'global_bgxxJosnData', classify='list',
                                      data_type='html')
        return check_flag
    ...
    def get_key_person_info(self, key_person_info):
        ...
        :return: 返回工商schema字典
        '''
        check_flag = self.check_field(field_info=key_person_info, feature_list=u'people-lists', classify='list',
                                      data_type='html')
        return check_flag
    ...
    def get_branch_info(self, branch_info):
        ...
        :return: 返回工商schema字典
        '''
        check_flag = self.check_field(field_info=branch_info, feature_list=u"分支机构信息", classify='list', data_type='html')
        return check_flag
    ...
    def get_contributive_info(self, contributive_info):
        ...
        :return: 返回工商schema字典
        '''
        check_list_flag = self.check_field(field_info=contributive_info, feature_list=u'股东及出资信息', classify='list',
                                           data_type='html')
        check_detail_flag = self.check_field(field_info=contributive_info, classify='detail', data_type='json')
