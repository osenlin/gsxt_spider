...
class CheckGuiZhouWorker(CheckBaseWorker):
    ...
    def get_base_info(self, base_info):
        ...
        check_flag = self.check_field(field_info=base_info, classify='list', data_type='json')
        return check_flag
    ...
    def get_change_info(self, change_info):
        ...
        :return: 返回工商schema字典
        '''
        check_flag = self.check_field(field_info=change_info, classify='list', data_type='json')
        return check_flag
    ...
    def get_key_person_info(self, key_person_info):
        ...
        check_flag = self.check_field(field_info=key_person_info, classify='list', data_type='json')
        return check_flag
    ...
    def get_branch_info(self, branch_info):
        ...
        :return: 返回工商schema字典
        '''
        check_flag = self.check_field(field_info=branch_info, classify='list', data_type='json')
        return check_flag
    ...
    def get_contributive_info(self, contributive_info):
        ...
        check_list_flag = self.check_field(field_info=contributive_info, classify='list', data_type='json')
        check_detail_flag = self.check_field(field_info=contributive_info, classify='list', data_type='json')
