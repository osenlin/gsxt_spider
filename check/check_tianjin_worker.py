...
class CheckTianJinWorker(CheckBaseWorker):
    ...
    def get_base_info(self, base_info):
        ...
        '''
        # 怎么写
        check_flag = self.check_field(field_info=base_info, feature_list=u"企业基本信息", classify='list', data_type='html')
        return check_flag
        #########
    ...
    def get_contributive_info(self, contributive_info):
        ...
        :return: 返回工商schema字典
        '''
        check_list_flag = self.check_field(field_info=contributive_info, classify='list',
                                           data_type='json')
        check_detail_flag = self.check_field(field_info=contributive_info, classify='detail',
                                             data_type='json')
